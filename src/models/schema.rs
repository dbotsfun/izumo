...
diesel::table! {
	/// Representation of the `bot_to_user` table.
	///
	/// (Automatically generated by Diesel.)
	bot_to_user (bot_id, user_id) {
		/// The `bot_id` column of the `bot_to_user` table.
		///
		/// Its SQL type is `Varchar`.
		///
		/// (Automatically generated by Diesel.)
		bot_id -> Varchar,
		/// The `user_id` column of the `bot_to_user` table.
		///
		/// Its SQL type is `Varchar`.
		///
		/// (Automatically generated by Diesel.)
		user_id -> Varchar,
		/// The `is_owner` column of the `bot_to_user` table.
		///
		/// Its SQL type is `Bool`.
		///
		/// (Automatically generated by Diesel.)
		is_owner -> Bool,
		/// The `permissions` column of the `bot_to_user` table.
		///
		/// Its SQL type is `Int4`.
		///
		/// (Automatically generated by Diesel.)
		permissions -> Int4,
		/// The `created_at` column of the `bot_to_user` table.
		///
...
diesel::joinable!(bot_to_user -> bots (bot_id));
diesel::joinable!(bot_to_user -> users (user_id));

diesel::allow_tables_to_appear_in_same_query!(bot_to_user, bots, users,);
