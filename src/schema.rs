...
diesel::table! {
    /// Representation of the `bot_votes` table.
    ///
    /// (Automatically generated by Diesel.)
    bot_votes (bot_id, date) {
        /// The `bot_id` column of the `bot_votes` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        bot_id -> Varchar,
        /// The `date` column of the `bot_votes` table.
        ///
        /// Its SQL type is `Date`.
        ///
        /// (Automatically generated by Diesel.)
        date -> Date,
        /// The `votes` column of the `bot_votes` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::table! {
    ...
    bots (id) {
        ...
        /// The `supported_languages` column of the `bots` table.
        ///
        /// Its SQL type is `Array<Nullable<Int4>>`.
        ///
        /// (Automatically generated by Diesel.)
        supported_languages -> Array<Nullable<Int4>>,
        /// The `guild_count` column of the `bots` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::table! {
    ...
    users (id) {
        ...
        /// (Automatically generated by Diesel.)
        updated_at -> Timestamp,
        /// The `dc_access_token` column of the `users` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        dc_access_token -> Varchar,
    }
}
...
diesel::joinable!(bot_votes -> bots (bot_id));
